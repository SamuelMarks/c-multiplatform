...
typedef struct CMPI18nEntry {
  ...
  cmp_usize value_len; /**< Value length in bytes (excluding null terminator). */
} CMPI18nEntry;
 ...
 * @return CMP_OK on success or a failure code.
 */
CMP_API int CMP_CALL cmp_i18n_contains(const CMPI18n *i18n, const char *utf8_key,
 ...
 * @return CMP_OK on success or a failure code.
 */
CMP_API int CMP_CALL cmp_i18n_test_is_leap_year(cmp_i32 year, CMPBool *out_leap);
 ...
 * @return CMP_OK on success or a failure code.
 */
CMP_API int CMP_CALL cmp_i18n_test_cstrlen(const char *cstr, cmp_usize *out_len);
 ...
 * @return CMP_OK on success or a failure code.
 */
CMP_API int CMP_CALL cmp_i18n_test_find_entry(const CMPI18n *i18n, const char *key,
                                           cmp_usize key_len,
                                           cmp_usize *out_index,
                                           CMPBool *out_found);
 ...
 * @return CMP_OK on success or a failure code.
 */
CMP_API int CMP_CALL cmp_i18n_test_set_ascii_lower_fail_after(cmp_u32 call_count);
 ...
 * @return CMP_OK on success or a failure code.
 */
CMP_API int CMP_CALL cmp_i18n_test_locale_preset_en_us(CMPI18nLocale *out_locale);
 ...
 * @return CMP_OK on success or a failure code.
 */
CMP_API int CMP_CALL cmp_i18n_test_locale_preset_en_gb(CMPI18nLocale *out_locale);
 ...
 * @return CMP_OK on success or a failure code.
 */
CMP_API int CMP_CALL cmp_i18n_test_locale_preset_fr_fr(CMPI18nLocale *out_locale);
 ...
 * @return CMP_OK on success or a failure code.
 */
CMP_API int CMP_CALL cmp_i18n_test_locale_preset_de_de(CMPI18nLocale *out_locale);
