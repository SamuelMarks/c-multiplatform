/**
 * @file ui_window_backend_macos.h
 * @brief macOS Cocoa + CGL window backend.
 */

#ifndef UI_WINDOW_BACKEND_MACOS_H
#define UI_WINDOW_BACKEND_MACOS_H
...
/**
 * @brief Creates a macOS Cocoa + CGL backend instance.
 *
...
/**
 * @brief Destroys a macOS Cocoa + CGL backend instance.
 *
...
#endif /* UI_WINDOW_BACKEND_MACOS_H */
