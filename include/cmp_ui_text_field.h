 ...
 */
int CMP_API cmp_ui_text_field_create(cmp_ui_text_field_t **out_field,
                                     const char *label);
 ...
 * \return 0 on success, or a non-zero error code on failure.
 */
int CMP_API cmp_ui_text_field_destroy(cmp_ui_text_field_t *field);
 ...
 * \return 0 on success, or a non-zero error code on failure.
 */
int CMP_API cmp_ui_text_field_get_node(cmp_ui_text_field_t *field,
 ...
 * \return 0 on success, or a non-zero error code on failure.
 */
int CMP_API cmp_ui_text_field_set_value(cmp_ui_text_field_t *field,
                                        const char *value);
 ...
 * \return 0 on success, or a non-zero error code on failure.
 */
int CMP_API cmp_ui_text_field_bind_a11y(cmp_ui_text_field_t *widget,
