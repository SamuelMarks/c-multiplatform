 ...
 */
enum ui_font_status {
  UI_FONT_STATUS_UNLOADED,
  UI_FONT_STATUS_LOADING,
  UI_FONT_STATUS_LOADED,
  UI_FONT_STATUS_ERROR
};
 ...
 */
struct ui_font_axis {
  unsigned int tag; /* e.g., 'wght', 'opsz' represented as 4-byte int */
  float value;
};
 ...
 *
 * @param manager The font manager to destroy.
 * @return UI_ERROR_NONE on success.
 */
 ...
 * @param font_data The TTF/OTF font data.
 * @param data_size The size of the font data.
 * @param out_font Pointer to receive the font handle.
 * @return UI_ERROR_NONE on success.
 */
 ...
 * @param is_italic Non-zero if italic/oblique.
 * @return UI_ERROR_NONE on success.
 */
 ...
 *
 * @param font The font.
 * @param out_status Pointer to receive the status.
 * @return UI_ERROR_NONE on success.
 */
 ...
 * @return UI_ERROR_NONE if a font is found, UI_ERROR_NOT_FOUND otherwise.
 */
 ...
 *
 * @param font The font.
 * @param out_data Pointer to receive the font data buffer.
 * @param out_size Pointer to receive the font data size.
 * @return UI_ERROR_NONE on success.
 */
 ...
 * @param font The font.
 * @param font_size The size of the font in pixels.
 * @param codepoints Array of Unicode codepoints to include.
 * @param codepoint_count Number of codepoints.
 * @param out_atlas_rgba Pointer to receive the generated RGBA atlas buffer.
 * @param out_width Pointer to receive the atlas width.
 * @param out_height Pointer to receive the atlas height.
 * @return UI_ERROR_NONE on success.
 */
...
/**
 * @brief Frees a generated atlas.
 *
 * @param atlas_rgba The atlas buffer.
 * @return UI_ERROR_NONE on success.
 */
