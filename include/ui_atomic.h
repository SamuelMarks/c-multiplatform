 ...
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t ui_atomic_add(ui_atomic_t *target,
                                                       long value,
                                                       long *out_old_value);
 ...
 * @return UI_ERROR_NONE on success, or an appropriate error code.
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t ui_atomic_cas(ui_atomic_t *target,
                                                       long expected,
                                                       long new_value,
                                                       int *out_swapped);
 ...
 * @return UI_ERROR_NONE on success, or an appropriate error code.
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t ui_atomic_load(ui_atomic_t *target,
                                                        long *out_value);
 ...
 * @return UI_ERROR_NONE on success, or an appropriate error code.
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t ui_atomic_store(ui_atomic_t *target,
                                                         long value);
 ...
 * @return UI_ERROR_NONE on success, or an appropriate error code.
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t ui_atomic_ptr_cas(
    void *volatile *target, void *expected, void *new_value, int *out_swapped);
#ifdef __cplusplus
}
#endif /* __cplusplus */
