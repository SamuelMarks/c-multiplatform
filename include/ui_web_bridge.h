 ...
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t ui_web_bridge_flush(void);

/**
 * \brief Shuts down the web bridge, freeing any allocated resources.
 * \return UI_ERROR_NONE on success.
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t ui_web_bridge_shutdown(void);
...
ui_web_bridge_create_node(ui_uint32 id, const char *tag_name);
 ...
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t
ui_web_bridge_destroy_node(ui_uint32 id);
 ...
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t
ui_web_bridge_set_text(ui_uint32 id, const char *text);
 ...
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t
ui_web_bridge_append_child(ui_uint32 parent_id, ui_uint32 child_id);
 ...
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t
ui_web_bridge_remove_child(ui_uint32 parent_id, ui_uint32 child_id);
 ...
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t
ui_web_bridge_set_bounds(ui_uint32 id, float x, float y, float w, float h);
 ...
 * \return UI_ERROR_NONE on success.
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t ui_web_bridge_insert_before(
    ui_uint32 parent_id, ui_uint32 child_id, ui_uint32 reference_id);
 ...
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t
ui_web_bridge_set_style(ui_uint32 id, const char *property, const char *value);
 ...
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t
ui_web_bridge_dispatch_event(int type, float x, float y, int buttons);
 ...
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t
ui_web_bridge_dispatch_resize(float w, float h, float dpr);
 ...
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t
ui_web_bridge_dispatch_key(int type, const char *key, int modifiers);
 ...
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t
ui_web_bridge_set_aria(ui_uint32 id, const char *role, const char *label,
                       int hidden, int disabled, int expanded, int checked);
 ...
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t
ui_web_bridge_push_state(const char *path);
 ...
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t
ui_web_bridge_replace_state(const char *path);
 ...
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t
ui_web_bridge_set_attribute(ui_uint32 id, const char *name, const char *value);
 ...
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t
ui_web_bridge_set_property(ui_uint32 id, const char *name, const char *value);
