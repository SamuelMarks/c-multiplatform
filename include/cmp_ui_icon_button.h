 ...
 */
CMP_API int cmp_ui_icon_button_create(cmp_ui_icon_button_t **out_btn,
 ...
 * \return 0 on success, or a non-zero error code on failure.
 */
CMP_API int cmp_ui_icon_button_destroy(cmp_ui_icon_button_t *btn);
 ...
 * \return 0 on success, or a non-zero error code on failure.
 */
CMP_API int cmp_ui_icon_button_get_node(cmp_ui_icon_button_t *btn,
 ...
 * \return 0 on success, or a non-zero error code on failure.
 */
CMP_API int cmp_ui_icon_button_set_icon(cmp_ui_icon_button_t *btn,
                                        const char *icon_name);
 ...
 * \return 0 on success, or a non-zero error code on failure.
 */
CMP_API int cmp_ui_icon_button_bind_a11y(cmp_ui_icon_button_t *widget,
