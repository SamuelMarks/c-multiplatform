 ...
 * @param out_available Receives M3_TRUE if Android is available, M3_FALSE otherwise.
 ...
 * @return M3_OK on success or a failure code.
 */
M3_API int M3_CALL m3_android_backend_config_init(M3AndroidBackendConfig *config);
 ...
 * @return M3_OK on success or a failure code.
 */
M3_API int M3_CALL m3_android_backend_create(const M3AndroidBackendConfig *config, M3AndroidBackend **out_backend);
 ...
 * @return M3_OK on success or a failure code.
 */
M3_API int M3_CALL m3_android_backend_get_ws(M3AndroidBackend *backend, M3WS *out_ws);
 ...
 * @return M3_OK on success or a failure code.
 */
M3_API int M3_CALL m3_android_backend_get_gfx(M3AndroidBackend *backend, M3Gfx *out_gfx);
