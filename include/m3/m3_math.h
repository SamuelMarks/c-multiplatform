 ...
 */
M3_API int M3_CALL m3_rect_intersect(const M3Rect *a, const M3Rect *b,
                                     M3Rect *out_rect,
                                     M3Bool *out_has_intersection);
 ...
 * @return M3_OK on success or a failure code.
 */
M3_API int M3_CALL m3_rect_union(const M3Rect *a, const M3Rect *b,
                                 M3Rect *out_rect);
 ...
 * @return M3_OK on success or a failure code.
 */
M3_API int M3_CALL m3_rect_contains_point(const M3Rect *rect, M3Scalar x,
                                          M3Scalar y, M3Bool *out_contains);
 ...
 * @return M3_OK on success or a failure code.
 */
M3_API int M3_CALL m3_mat3_mul(const M3Mat3 *a, const M3Mat3 *b,
                               M3Mat3 *out_mat);
 ...
 * @return M3_OK on success or a failure code.
 */
M3_API int M3_CALL m3_mat3_transform_point(const M3Mat3 *m, M3Scalar x,
