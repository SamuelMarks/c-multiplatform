 ...
 * @return M3_OK on success or a failure code.
 */
M3_API int M3_CALL m3_text_backend_from_gfx(const M3Gfx *gfx,
 ...
 * @return M3_OK on success or a failure code.
 */
M3_API int M3_CALL m3_text_font_create(const M3TextBackend *backend,
 ...
 * @return M3_OK on success or a failure code.
 */
M3_API int M3_CALL m3_text_font_destroy(const M3TextBackend *backend,
                                        M3Handle font);
 ...
 * @return M3_OK on success or a failure code.
 */
M3_API int M3_CALL m3_text_measure_utf8(const M3TextBackend *backend,
 ...
 * @return M3_OK on success or a failure code.
 */
M3_API int M3_CALL m3_text_measure_cstr(const M3TextBackend *backend,
                                        M3Handle font, const char *utf8,
                                        M3TextMetrics *out_metrics);
 ...
 * @return M3_OK on success or a failure code.
 */
M3_API int M3_CALL m3_text_font_metrics(const M3TextBackend *backend,
                                        M3Handle font,
                                        M3TextMetrics *out_metrics);
 ...
 * @return M3_OK on success or a failure code.
 */
M3_API int M3_CALL m3_text_widget_init(M3TextWidget *widget,
 ...
 * @return M3_OK on success or a failure code.
 */
M3_API int M3_CALL m3_text_widget_set_text(M3TextWidget *widget,
                                           const char *utf8, m3_usize utf8_len);
 ...
 * @return M3_OK on success or a failure code.
 */
M3_API int M3_CALL m3_text_widget_set_style(M3TextWidget *widget,
                                            const M3TextStyle *style);
 ...
 * @return M3_OK on success or a failure code.
 */
M3_API int M3_CALL m3_text_widget_get_metrics(M3TextWidget *widget,
                                              M3TextMetrics *out_metrics);
