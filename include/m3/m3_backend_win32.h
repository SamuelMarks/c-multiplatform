 ...
 * @param out_available Receives M3_TRUE if Win32 support is available, M3_FALSE
 * otherwise.
 ...
 * @return M3_OK on success or a failure code.
 */
M3_API int M3_CALL m3_win32_backend_create(const M3Win32BackendConfig *config,
 ...
 * @return M3_OK on success or a failure code.
 */
M3_API int M3_CALL m3_win32_backend_get_ws(M3Win32Backend *backend,
                                           M3WS *out_ws);
 ...
 * @return M3_OK on success or a failure code.
 */
M3_API int M3_CALL m3_win32_backend_get_gfx(M3Win32Backend *backend,
                                            M3Gfx *out_gfx);
 ...
 * @return M3_OK on success or a failure code.
 */
M3_API int M3_CALL m3_win32_backend_get_env(M3Win32Backend *backend,
                                            M3Env *out_env);
