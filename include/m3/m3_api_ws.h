...
typedef struct M3WSVTable {
   ...
   * @return M3_OK on success or a failure code.
   */
  int(M3_CALL *create_window)(void *ws, const M3WSWindowConfig *config,
                              M3Handle *out_window);
  /**
   ...
   * @return M3_OK on success or a failure code.
   */
  int(M3_CALL *set_window_title)(void *ws, M3Handle window,
   ...
   * @return M3_OK on success or a failure code.
   */
  int(M3_CALL *set_window_size)(void *ws, M3Handle window, m3_i32 width,
                                m3_i32 height);
  /**
   ...
   * @return M3_OK on success or a failure code.
   */
  int(M3_CALL *get_window_size)(void *ws, M3Handle window, m3_i32 *out_width,
                                m3_i32 *out_height);
  /**
   ...
   * @return M3_OK on success or a failure code.
   */
  int(M3_CALL *get_window_dpi_scale)(void *ws, M3Handle window,
                                     M3Scalar *out_scale);
  /**
   ...
   * @return M3_OK on success or a failure code.
   */
  int(M3_CALL *get_clipboard_text)(void *ws, char *buffer, m3_usize buffer_size,
                                   m3_usize *out_length);
  /**
   ...
   * @return M3_OK on success or a failure code.
   */
  int(M3_CALL *poll_event)(void *ws, M3InputEvent *out_event,
