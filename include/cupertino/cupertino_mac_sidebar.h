...
typedef struct CupertinoMacSidebar {
    ...
    CMPBool is_window_active;                     /**< Whether the window is focused (affects selection color). */
} CupertinoMacSidebar;
 ...
 * @param is_section_header CMP_TRUE if this row is a section header (non-selectable, grey text).
 * @return CMP_OK on success or an error code.
 */
