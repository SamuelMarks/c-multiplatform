...
/**
 * @brief Retrieves the semantic system color for a given identifier, adapting
 * to light/dark mode.
 ...
 */
CMP_API int CMP_CALL cupertino_color_get_system(CupertinoSystemColor color_id,
                                                CMPBool is_dark,
                                                CMPColor *out_color);
