...
#define CUPERTINO_ACTION_SHEET_MAX_ACTIONS 8 /**< Max actions allowed in one sheet */
...
typedef struct CupertinoActionSheet {
    ...
    CupertinoAction actions[CUPERTINO_ACTION_SHEET_MAX_ACTIONS]; /**< Configured actions */
