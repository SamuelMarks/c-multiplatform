 ...
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t ui_speed_dial_base_init(
    struct ui_speed_dial_base *speed_dial, struct ui_component *component);
 ...
 * @return UI_ERROR_NONE on success, or an appropriate error code.
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t ui_speed_dial_base_add_action(
    struct ui_speed_dial_base *speed_dial, int id, struct ui_fab_base *fab);
...
ui_speed_dial_base_toggle(struct ui_speed_dial_base *speed_dial);
 ...
 * @return UI_ERROR_NONE on success, or an appropriate error code.
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t ui_speed_dial_base_bind_disabled(
    struct ui_speed_dial_base *widget, struct ui_signal *disabled_signal);
 ...
 * @return UI_ERROR_NONE on success, or an appropriate error code.
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t ui_speed_dial_base_bind_text(
    struct ui_speed_dial_base *widget, struct ui_signal *text_signal);
