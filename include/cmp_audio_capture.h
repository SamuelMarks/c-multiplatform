 ...
 */
CMP_API int cmp_audio_capture_create(cmp_audio_capture_t **out_capture);
 ...
 * @return 0 on success, or an error code.
 */
CMP_API int cmp_audio_capture_destroy(cmp_audio_capture_t *capture);
 ...
 * @return 0 on success, or an error code.
 */
CMP_API int cmp_audio_capture_start(cmp_audio_capture_t *capture);
 ...
 * @return 0 on success, or an error code.
 */
CMP_API int cmp_audio_capture_stop(cmp_audio_capture_t *capture);
 ...
 * @return 0 on success, or an error code.
 */
CMP_API int cmp_audio_capture_get_wav(cmp_audio_capture_t *capture,
 ...
 * @return 0 on success, or an error code.
 */
CMP_API int cmp_audio_capture_free_wav(unsigned char *wav_data);
