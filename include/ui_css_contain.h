...
enum ui_css_contain_flags {
  UI_CSS_CONTAIN_NONE = 0,
  UI_CSS_CONTAIN_STRICT = 1 << 0,
  UI_CSS_CONTAIN_CONTENT = 1 << 1,
  UI_CSS_CONTAIN_SIZE = 1 << 2,
  UI_CSS_CONTAIN_LAYOUT = 1 << 3,
  UI_CSS_CONTAIN_STYLE = 1 << 4,
  UI_CSS_CONTAIN_PAINT = 1 << 5,
  UI_CSS_CONTAIN_INLINE_SIZE = 1 << 6
};
...
enum ui_css_content_visibility {
  UI_CSS_CONTENT_VISIBILITY_VISIBLE,
  UI_CSS_CONTENT_VISIBILITY_AUTO,
  UI_CSS_CONTENT_VISIBILITY_HIDDEN
};
...
struct ui_css_contain_intrinsic_size {
  struct ui_css_contain_intrinsic_dim width;
  struct ui_css_contain_intrinsic_dim height;
};
