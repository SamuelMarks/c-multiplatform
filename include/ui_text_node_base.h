...
ui_text_node_base_create(struct ui_text_node_base **out_node);
 ...
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t
ui_text_node_base_destroy(struct ui_text_node_base *node);
 ...
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t
ui_text_node_base_set_text(struct ui_text_node_base *node, const char *text);
 ...
 * @return UI_ERROR_NONE on success.
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t ui_text_node_base_get_text(
    const struct ui_text_node_base *node, const char **out_text);
 ...
 * @return UI_ERROR_NONE on success.
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t ui_text_node_base_set_font_manager(
    struct ui_text_node_base *node, struct ui_font_manager *font_manager);
 ...
 * @return UI_ERROR_NONE on success.
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t ui_text_node_base_set_font_family(
    struct ui_text_node_base *node, const char *family);
 ...
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t
ui_text_node_base_set_font_size(struct ui_text_node_base *node, float size);
 ...
 * @return UI_ERROR_NONE on success.
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t ui_text_node_base_set_max_width(
    struct ui_text_node_base *node, float max_width);
 ...
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t
ui_text_node_base_set_max_lines(struct ui_text_node_base *node, int max_lines);
 ...
 * @return UI_ERROR_NONE on success.
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t ui_text_node_base_set_overflow(
    struct ui_text_node_base *node, enum ui_text_node_overflow overflow);
 ...
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t
ui_text_node_base_update_layout(struct ui_text_node_base *node);
 ...
 * @return UI_ERROR_NONE on success.
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t ui_text_node_base_get_layout(
    struct ui_text_node_base *node, struct ui_text_layout **out_layout);
 ...
 * @return UI_ERROR_NONE on success.
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t ui_text_node_base_get_component(
    struct ui_text_node_base *node, struct ui_component **out_component);
 ...
 * @return UI_ERROR_NONE on success.
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t ui_text_node_base_bind_text(
    struct ui_text_node_base *widget, struct ui_signal *signal);
