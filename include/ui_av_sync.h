...
ui_av_sync_init(struct ui_av_sync *sync);
 ...
 * @return UI_ERROR_NONE on success.
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t ui_av_sync_update_audio_pts(
    struct ui_av_sync *sync, ui_int64 audio_pts_us, ui_int64 sys_time_us);
 ...
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t
ui_av_sync_tick_system(struct ui_av_sync *sync, ui_int64 sys_time_us);
 ...
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t
ui_av_sync_get_clock(struct ui_av_sync *sync, ui_int64 *out_clock_us);
