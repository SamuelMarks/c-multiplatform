 ...
 * @param out_is_dark Pointer to receive 1 if dark mode is preferred, 0 for light.
 * @return 0 on success.
 */
 ...
 * @param out_is_high_contrast Pointer to receive 1 if high contrast is active, 0 otherwise.
 * @return 0 on success.
 */
