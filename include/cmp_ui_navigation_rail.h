 ...
 */
int CMP_API cmp_ui_navigation_rail_create(cmp_ui_navigation_rail_t **out_rail);
 ...
 * \return 0 on success, or a non-zero error code on failure.
 */
int CMP_API cmp_ui_navigation_rail_destroy(cmp_ui_navigation_rail_t *rail);
 ...
 * \return 0 on success, or a non-zero error code on failure.
 */
int CMP_API cmp_ui_navigation_rail_get_node(cmp_ui_navigation_rail_t *rail,
 ...
 * \return 0 on success, or a non-zero error code on failure.
 */
int CMP_API cmp_ui_navigation_rail_add_destination(
    cmp_ui_navigation_rail_t *rail, const char *icon_name, const char *label,
    int *out_index);
 ...
 * \return 0 on success, or a non-zero error code on failure.
 */
int CMP_API cmp_ui_navigation_rail_set_selected(cmp_ui_navigation_rail_t *rail,
                                                int index);
 ...
 * \return 0 on success, or a non-zero error code on failure.
 */
int CMP_API cmp_ui_navigation_rail_bind_a11y(cmp_ui_navigation_rail_t *widget,
