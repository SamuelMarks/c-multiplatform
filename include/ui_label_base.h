...
ui_label_base_create(struct ui_label_base **out_label);
 ...
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t
ui_label_base_destroy(struct ui_label_base *label);
 ...
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t
ui_label_base_set_for(struct ui_label_base *label, const char *target_id);
 ...
 * @return UI_ERROR_NONE on success, or an appropriate error code.
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t ui_label_base_set_target_node(
    struct ui_label_base *label, struct ui_dom_node *target_node);
 ...
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t
ui_label_base_process_event(struct ui_label_base *label,
 ...
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t ui_label_base_get_component(
    struct ui_label_base *label, struct ui_component **out_component);
