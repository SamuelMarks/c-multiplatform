 ...
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t ui_css_parse_scrollbar_width(
    const char *str, enum ui_css_scrollbar_width *out_width);
 ...
 * @return `UI_ERROR_NONE` on success, or an appropriate error code on failure.
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t ui_css_parse_scrollbar_color(
    const char *str, struct ui_css_scrollbar_color *out_color);
