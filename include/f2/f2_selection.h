...
/**
 * @file f2_selection.h
 * @brief Microsoft Fluent 2 selection widgets (checkbox, switch, radio, slider).
 */
...
typedef int(CMP_CALL *F2CheckboxOnChange)(void *ctx, struct F2Checkbox *checkbox, CMPBool checked);
...
typedef int(CMP_CALL *F2SwitchOnChange)(void *ctx, struct F2Switch *widget, CMPBool on);
...
typedef int(CMP_CALL *F2RadioOnChange)(void *ctx, struct F2Radio *radio, CMPBool selected);
