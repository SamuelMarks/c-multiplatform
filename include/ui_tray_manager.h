...
ui_tray_manager_create(struct ui_tray_manager **out_tray);
 ...
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t
ui_tray_manager_destroy(struct ui_tray_manager *tray);
 ...
 * @return UI_ERROR_NONE on success.
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t ui_tray_manager_set_icon(
    struct ui_tray_manager *tray, struct ui_image_base *image);
 ...
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t
ui_tray_manager_set_tooltip(struct ui_tray_manager *tray, const char *tooltip);
 ...
 * @return UI_ERROR_NONE on success.
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t ui_tray_manager_set_context_menu(
    struct ui_tray_manager *tray, struct ui_menu_base *menu);
 ...
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t
ui_tray_manager_show(struct ui_tray_manager *tray);
 ...
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t
ui_tray_manager_hide(struct ui_tray_manager *tray);
