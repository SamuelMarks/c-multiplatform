...
/**
 * @brief Pre-defined Fluent 2 Shared Colors
 */
typedef enum cmp_f2_base_color {
  CMP_F2_COLOR_RED = 0xD13438,
  CMP_F2_COLOR_DARK_RED = 0x59000B,
  CMP_F2_COLOR_CRANBERRY = 0xC50F1F,
  CMP_F2_COLOR_PUMPKIN = 0xCA5010,
  CMP_F2_COLOR_PEACH = 0xFF8C00,
  CMP_F2_COLOR_MARIGOLD = 0xEAA300,
  CMP_F2_COLOR_YELLOW = 0xFFE000,
  CMP_F2_COLOR_GOLD = 0xFFB900,
  CMP_F2_COLOR_BRASS = 0x986F0B,
  CMP_F2_COLOR_BROWN = 0x8E562E,
  CMP_F2_COLOR_FOREST = 0x498205,
  CMP_F2_COLOR_SEAFOAM = 0x00CC6A,
  CMP_F2_COLOR_DARK_GREEN = 0x0B6A0B,
  CMP_F2_COLOR_LIGHT_TEAL = 0x00B7C3,
  CMP_F2_COLOR_TEAL = 0x038387,
  CMP_F2_COLOR_STEEL = 0x005B70,
  CMP_F2_COLOR_BLUE = 0x0078D4,
  CMP_F2_COLOR_ROYAL_BLUE = 0x004E8C,
  CMP_F2_COLOR_CORNFLOWER = 0x4F6BED,
  CMP_F2_COLOR_NAVY = 0x00275B,
  CMP_F2_COLOR_LAVENDER = 0x7160E8,
  CMP_F2_COLOR_PURPLE = 0x5C2E91,
  CMP_F2_COLOR_GRAPE = 0x881798,
  CMP_F2_COLOR_BERRY = 0xC239B3,
  CMP_F2_COLOR_PINK = 0xE43BA6,
  CMP_F2_COLOR_MAGENTA = 0xBF0077,
  CMP_F2_COLOR_PLUM = 0x770039
} cmp_f2_base_color_t;
