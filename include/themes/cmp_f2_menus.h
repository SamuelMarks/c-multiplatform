...
int CMP_API cmp_f2_menu_item_set_shortcut(cmp_ui_node_t *node,
                                          const char *shortcut);
int CMP_API cmp_f2_menu_item_set_disabled(cmp_ui_node_t *node, int is_disabled);
 ...
 * an error code.
 */
int CMP_API cmp_f2_nav_item_create(cmp_ui_node_t **out_node, const char *label);
 ...
 * an error code.
 */
int CMP_API cmp_f2_tab_item_create(cmp_ui_node_t **out_node, const char *label);
int CMP_API cmp_f2_tab_item_set_selected(cmp_ui_node_t *node, int is_selected);
