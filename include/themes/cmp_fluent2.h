#ifndef CMP_FLUENT2_H
#define CMP_FLUENT2_H
...
/**
 * @brief Measures a Fluent 2 style button.
...
int cmp_fluent2_measure_button(const cmp_ui_node_t *node, float *width,
                               float *height);
/**
 * @brief Measures a Fluent 2 style text input.
 * @param node The UI node.
 * @param width Output calculated width.
 * @param height Output calculated height.
 * @return CMP_SUCCESS on success, error code otherwise.
...
int cmp_fluent2_measure_text_input(const cmp_ui_node_t *node, float *width,
                                   float *height);
/**
 * @brief Measures a Fluent 2 style slider.
 * @param node The UI node.
 * @param width Output calculated width.
 * @param height Output calculated height.
 * @return CMP_SUCCESS on success, error code otherwise.
...
int cmp_fluent2_measure_slider(const cmp_ui_node_t *node, float *width,
                               float *height);
/**
 * @brief Measures a Fluent 2 style toggle switch.
 * @param node The UI node.
 * @param width Output calculated width.
 * @param height Output calculated height.
 * @return CMP_SUCCESS on success, error code otherwise.
...
int cmp_fluent2_measure_toggle(const cmp_ui_node_t *node, float *width,
                               float *height);
/**
 * @brief Measures a Fluent 2 style checkbox.
 * @param node The UI node.
 * @param width Output calculated width.
 * @param height Output calculated height.
 * @return CMP_SUCCESS on success, error code otherwise.
...
int cmp_fluent2_measure_checkbox(const cmp_ui_node_t *node, float *width,
                                 float *height);
/**
 * @brief Measures a Fluent 2 style radio button.
 * @param node The UI node.
 * @param width Output calculated width.
 * @param height Output calculated height.
 * @return CMP_SUCCESS on success, error code otherwise.
...
int cmp_fluent2_measure_radio(const cmp_ui_node_t *node, float *width,
                              float *height);
/**
 * @brief Measures a Fluent 2 style progress bar.
 * @param node The UI node.
 * @param width Output calculated width.
 * @param height Output calculated height.
 * @return CMP_SUCCESS on success, error code otherwise.
...
int cmp_fluent2_measure_progress(const cmp_ui_node_t *node, float *width,
                                 float *height);
/**
 * @brief Measures a Fluent 2 style dropdown menu.
 * @param node The UI node.
 * @param width Output calculated width.
 * @param height Output calculated height.
 * @return CMP_SUCCESS on success, error code otherwise.
...
/**
 * @brief Gets the ripple animation configuration for Fluent 2 style elements.
 * @param node The UI node.
 * @param duration Output ripple duration.
 * @param opacity Output ripple opacity.
 * @return CMP_SUCCESS on success, error code otherwise.
 */
int cmp_fluent2_get_ripple_config(const cmp_ui_node_t *node, float *duration,
                                  float *opacity);
/**
 * @brief Gets the state layer opacity for Fluent 2 style elements.
 * @param node The UI node.
...
int cmp_fluent2_get_state_layer_opacity(const cmp_ui_node_t *node, int state,
                                        float *opacity);
/**
 * @brief Gets the transition duration for Fluent 2 style elements.
 * @param node The UI node.
...
extern const cmp_theme_vtable_t cmp_fluent2_vtable;
