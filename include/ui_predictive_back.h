 ...
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t
ui_predictive_back_destroy(struct ui_predictive_back *tracker);
 ...
 * @return UI_ERROR_NONE on success.
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t ui_predictive_back_configure(
    struct ui_predictive_back *tracker, int edge_width_px, int screen_width_px);
 ...
 * @return UI_ERROR_NONE on success.
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t ui_predictive_back_bind_progress(
    struct ui_predictive_back *tracker, struct ui_signal *progress_signal);
 ...
 * @return UI_ERROR_NONE on success.
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t ui_predictive_back_bind_commit(
    struct ui_predictive_back *tracker, struct ui_signal *commit_signal);
 ...
 * @return UI_ERROR_NONE on success.
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t ui_predictive_back_process_event(
    struct ui_predictive_back *tracker, const struct ui_event *event);
