 ...
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t
ui_bottom_sheet_base_destroy(struct ui_bottom_sheet_base *sheet);
 ...
 * @return UI_ERROR_NONE on success.
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t ui_bottom_sheet_base_set_content(
    struct ui_bottom_sheet_base *sheet, struct ui_component *content);
 ...
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t
ui_bottom_sheet_base_set_open(struct ui_bottom_sheet_base *sheet, int is_open);
 ...
 * @return UI_ERROR_NONE on success.
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t ui_bottom_sheet_base_is_open(
    const struct ui_bottom_sheet_base *sheet, int *out_is_open);
 ...
 * @return UI_ERROR_NONE on success.
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t ui_bottom_sheet_base_set_on_close(
    struct ui_bottom_sheet_base *sheet, ui_bottom_sheet_on_close_t on_close,
    void *user_data);
 ...
 * @return UI_ERROR_NONE on success.
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t ui_bottom_sheet_base_process_event(
    struct ui_bottom_sheet_base *sheet, const struct ui_event *event,
    double timestamp_ms);
 ...
 * @return UI_ERROR_NONE on success.
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t ui_bottom_sheet_base_update(
    struct ui_bottom_sheet_base *sheet, double timestamp_ms);
 ...
 * @return UI_ERROR_NONE on success.
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t ui_bottom_sheet_base_set_spring_config(
    struct ui_bottom_sheet_base *sheet, const struct ui_spring_config *config);
 ...
 * @return UI_ERROR_NONE on success.
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t ui_bottom_sheet_base_get_component(
    struct ui_bottom_sheet_base *sheet, struct ui_component **out_component);
 ...
 * @return UI_ERROR_NONE on success.
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t ui_bottom_sheet_base_bind_open(
    struct ui_bottom_sheet_base *sheet, struct ui_signal *open_signal);
