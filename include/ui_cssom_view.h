 ...
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t ui_cssom_view_get_bounding_client_rect(
    const struct ui_layout_node *node, struct ui_dom_rect *out_rect);
 ...
 * @return UI_ERROR_NONE on success.
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t ui_cssom_view_get_client_width(
    const struct ui_layout_node *node, float *out_width);
 ...
 * @return UI_ERROR_NONE on success.
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t ui_cssom_view_get_client_height(
    const struct ui_layout_node *node, float *out_height);
...
ui_cssom_view_get_client_top(const struct ui_layout_node *node, float *out_top);
 ...
 * @return UI_ERROR_NONE on success.
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t ui_cssom_view_get_client_left(
    const struct ui_layout_node *node, float *out_left);
 ...
 * @return UI_ERROR_NONE on success.
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t ui_cssom_view_get_scroll_width(
    const struct ui_layout_node *node, float *out_width);
 ...
 * @return UI_ERROR_NONE on success.
 */
extern C_MULTIPLATFORM_EXPORT ui_error_t ui_cssom_view_get_scroll_height(
    const struct ui_layout_node *node, float *out_height);
