...
static int m3_checkbox_widget_event(void *widget, const M3InputEvent *event,
                                    M3Bool *out_handled) {
  M3Checkbox *checkbox;
  M3Bool prev_checked;
  M3Bool next_checked;
...
static int m3_switch_widget_measure(void *widget, M3MeasureSpec width,
                                    M3MeasureSpec height, M3Size *out_size) {
  M3Switch *sw;
  int rc;
...
int M3_CALL m3_checkbox_init(M3Checkbox *checkbox, const M3CheckboxStyle *style,
                             M3Bool checked) {
  int rc;
...
int M3_CALL m3_checkbox_get_checked(const M3Checkbox *checkbox,
                                    M3Bool *out_checked) {
...
int M3_CALL m3_checkbox_set_style(M3Checkbox *checkbox,
...
int M3_CALL m3_checkbox_set_label(M3Checkbox *checkbox, const char *utf8_label,
                                  m3_usize utf8_len) {
  if (checkbox == NULL) {
    return M3_ERR_INVALID_ARGUMENT;
  }
...
int M3_CALL m3_switch_init(M3Switch *widget, const M3SwitchStyle *style,
                           M3Bool on) {
  int rc;
...
int M3_CALL m3_switch_set_label(M3Switch *widget, const char *utf8_label,
                                m3_usize utf8_len) {
  if (widget == NULL) {
    return M3_ERR_INVALID_ARGUMENT;
  }
...
int M3_CALL m3_radio_init(M3Radio *radio, const M3RadioStyle *style,
                          M3Bool selected) {
  int rc;
...
int M3_CALL m3_radio_set_label(M3Radio *radio, const char *utf8_label,
                               m3_usize utf8_len) {
  if (radio == NULL) {
    return M3_ERR_INVALID_ARGUMENT;
  }
