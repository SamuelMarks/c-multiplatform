...
static int m3_arena_align_offset(m3_usize offset, m3_usize alignment, m3_usize *out_aligned)
{
    m3_usize mask;
    m3_usize max_value;
...
static int m3_arena_allocate_block(M3Arena *arena, m3_usize capacity, M3ArenaBlock **out_block)
{
...
int M3_CALL m3_arena_init(M3Arena *arena, const M3Allocator *allocator, m3_usize block_size)
{
...
int M3_CALL m3_arena_alloc(M3Arena *arena, m3_usize size, m3_usize alignment, void **out_ptr)
{
    M3ArenaBlock *block;
