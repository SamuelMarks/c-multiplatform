/**
 * @file ui_list_base.c
 * @brief ui_list_base.c implementation.
 */
/*
 * @file ui_list_base.c
...
struct ui_list_base {
  ...
  enum ui_list_orientation orientation; /**< orientation */
...
/**
 * @brief Sets the orientation of the list widget.
...
/**
 * @brief Gets the orientation of the list widget.
 * @param[in] list The list widget.
 * @param[out] out_orientation Pointer to store the orientation.
 * @return UI_ERROR_NONE on success.
 */
ui_error_t
...
/**
 * @brief Gets the component of the list item widget.
 * @param[in] item The list item widget.
