...
CMP_API int CMP_CALL f2_typography_scale_init(F2TypographyScale *scale) {
  ...
  set_style(&scale->roles[F2_TYPOGRAPHY_BODY_STRONG], f2_family, 14, 600,
            20.0f);
  ...
  set_style(&scale->roles[F2_TYPOGRAPHY_TITLE_LARGE], f2_family, 28, 600,
            36.0f);
  set_style(&scale->roles[F2_TYPOGRAPHY_DISPLAY], f2_family, 32, 600, 40.0f);
  set_style(&scale->roles[F2_TYPOGRAPHY_DISPLAY_LARGE], f2_family, 40, 600,
            52.0f);
  set_style(&scale->roles[F2_TYPOGRAPHY_DISPLAY_EXTRA_LARGE], f2_family, 68,
            600, 92.0f);
