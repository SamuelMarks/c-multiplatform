...
static int CMP_CALL cmp_ios_env_navigate_url(void *env, const char *utf8_url) {
  (void)env;
  (void)utf8_url;
  return CMP_ERR_UNSUPPORTED;
}

static int CMP_CALL cmp_ios_env_get_arg(void *env, const char *key, const char **out_value) {
  (void)env;
  (void)key;
