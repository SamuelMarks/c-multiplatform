...
static int CMP_CALL cmp_win32_env_navigate_url(void *env,
                                               const char *utf8_url) {
  (void)env;
  (void)utf8_url;
  return CMP_ERR_UNSUPPORTED;
...
static int CMP_CALL cmp_win32_env_get_arg(void *env, const char *key,
...
static const CMPEnvVTable g_cmp_win32_env_vtable = {
    ...
    cmp_win32_env_get_tasks,    cmp_win32_env_get_time_ms,
    cmp_win32_env_navigate_url, cmp_win32_env_get_arg};
