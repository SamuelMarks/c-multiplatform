...
struct ui_toggle_base {
  ...
  ui_toggle_on_change_t on_change; /**< on_change */
  ...
  struct ui_toggle_base *next; /**< next */
  /* @brief Previous toggle in the global registry. */
  struct ui_toggle_base *prev; /**< prev */
};

/** @brief Global radio registry */
