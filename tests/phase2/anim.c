...
int main(void)
{
    ...
    M3_TEST_EXPECT(m3_anim_timing_init(NULL, 0.0f, 1.0f, 1.0f, M3_ANIM_EASE_LINEAR), M3_ERR_INVALID_ARGUMENT);
    M3_TEST_EXPECT(m3_anim_timing_init(&timing, 0.0f, 1.0f, -1.0f, M3_ANIM_EASE_LINEAR), M3_ERR_RANGE);
    M3_TEST_EXPECT(m3_anim_timing_init(&timing, 0.0f, 1.0f, 1.0f, 99), M3_ERR_INVALID_ARGUMENT);
    M3_TEST_OK(m3_anim_timing_init(&timing, 0.0f, 10.0f, 1.0f, M3_ANIM_EASE_LINEAR));

    M3_TEST_EXPECT(m3_anim_timing_step(NULL, 0.1f, &value, &finished), M3_ERR_INVALID_ARGUMENT);
    M3_TEST_EXPECT(m3_anim_timing_step(&timing, 0.1f, NULL, &finished), M3_ERR_INVALID_ARGUMENT);
    M3_TEST_EXPECT(m3_anim_timing_step(&timing, 0.1f, &value, NULL), M3_ERR_INVALID_ARGUMENT);
    M3_TEST_EXPECT(m3_anim_timing_step(&timing, -0.1f, &value, &finished), M3_ERR_RANGE);
    ...
    timing.easing = 99;
    M3_TEST_EXPECT(m3_anim_timing_step(&timing, 0.1f, &value, &finished), M3_ERR_INVALID_ARGUMENT);
    timing.easing = M3_ANIM_EASE_LINEAR;

    M3_TEST_OK(m3_anim_timing_init(&timing, 5.0f, 7.0f, 0.0f, M3_ANIM_EASE_LINEAR));
    ...
    M3_TEST_EXPECT(m3_anim_test_apply_ease(99, 0.5f, &value), M3_ERR_INVALID_ARGUMENT);
    M3_TEST_EXPECT(m3_anim_test_apply_ease(M3_ANIM_EASE_LINEAR, 0.5f, NULL), M3_ERR_INVALID_ARGUMENT);
    ...
    M3_TEST_EXPECT(m3_spring_init(NULL, 0.0f, 1.0f, 1.0f, 0.0f, 1.0f), M3_ERR_INVALID_ARGUMENT);
    M3_TEST_EXPECT(m3_spring_init(&spring, 0.0f, 1.0f, 0.0f, 0.0f, 1.0f), M3_ERR_RANGE);
    M3_TEST_EXPECT(m3_spring_init(&spring, 0.0f, 1.0f, 1.0f, -1.0f, 1.0f), M3_ERR_RANGE);
    M3_TEST_EXPECT(m3_spring_init(&spring, 0.0f, 1.0f, 1.0f, 0.0f, 0.0f), M3_ERR_RANGE);
    ...
    M3_TEST_EXPECT(m3_spring_set_tolerance(NULL, 0.1f, 0.1f), M3_ERR_INVALID_ARGUMENT);
    ...
    M3_TEST_EXPECT(m3_spring_step(NULL, 0.1f, &finished), M3_ERR_INVALID_ARGUMENT);
    ...
    M3_TEST_EXPECT(m3_anim_controller_get_value(NULL, &value), M3_ERR_INVALID_ARGUMENT);
    M3_TEST_EXPECT(m3_anim_controller_get_value(&controller, NULL), M3_ERR_INVALID_ARGUMENT);
    M3_TEST_OK(m3_anim_controller_get_value(&controller, &value));
    M3_TEST_ASSERT(value == 0.0f);
    M3_TEST_EXPECT(m3_anim_controller_is_running(NULL, &running), M3_ERR_INVALID_ARGUMENT);
    M3_TEST_EXPECT(m3_anim_controller_is_running(&controller, NULL), M3_ERR_INVALID_ARGUMENT);
    ...
    M3_TEST_EXPECT(m3_anim_controller_step(NULL, 0.1f, &value, &finished), M3_ERR_INVALID_ARGUMENT);
    M3_TEST_EXPECT(m3_anim_controller_step(&controller, 0.1f, NULL, &finished), M3_ERR_INVALID_ARGUMENT);
    M3_TEST_EXPECT(m3_anim_controller_step(&controller, 0.1f, &value, NULL), M3_ERR_INVALID_ARGUMENT);
    M3_TEST_EXPECT(m3_anim_controller_step(&controller, 0.1f, &value, &finished), M3_ERR_STATE);
    M3_TEST_EXPECT(m3_anim_controller_step(&controller, -0.1f, &value, &finished), M3_ERR_RANGE);

    M3_TEST_EXPECT(m3_anim_controller_start_timing(NULL, 0.0f, 1.0f, 1.0f, M3_ANIM_EASE_LINEAR), M3_ERR_INVALID_ARGUMENT);
    M3_TEST_EXPECT(m3_anim_controller_start_timing(&controller, 0.0f, 1.0f, 1.0f, 99), M3_ERR_INVALID_ARGUMENT);
    M3_TEST_OK(m3_anim_controller_start_timing(&controller, 0.0f, 1.0f, 0.0f, M3_ANIM_EASE_LINEAR));
    M3_TEST_OK(m3_anim_controller_is_running(&controller, &running));
    M3_TEST_ASSERT(running == M3_FALSE);
    ...
    M3_TEST_OK(m3_anim_controller_start_timing(&controller, 0.0f, 1.0f, 1.0f, M3_ANIM_EASE_LINEAR));
    M3_TEST_OK(m3_anim_controller_is_running(&controller, &running));
    ...
    M3_TEST_EXPECT(m3_anim_controller_start_spring(NULL, 0.0f, 1.0f, 60.0f, 8.0f, 1.0f), M3_ERR_INVALID_ARGUMENT);
    M3_TEST_EXPECT(m3_anim_controller_start_spring(&controller, 0.0f, 1.0f, 0.0f, 8.0f, 1.0f), M3_ERR_RANGE);
    M3_TEST_OK(m3_anim_controller_start_spring(&controller, 0.0f, 1.0f, 60.0f, 8.0f, 1.0f));
    M3_TEST_EXPECT(m3_anim_controller_set_spring_target(NULL, 2.0f), M3_ERR_INVALID_ARGUMENT);
    ...
    M3_TEST_OK(m3_anim_controller_start_timing(&controller, 0.0f, 1.0f, 1.0f, M3_ANIM_EASE_LINEAR));
    M3_TEST_EXPECT(m3_anim_controller_set_spring_target(&controller, 3.0f), M3_ERR_STATE);

    controller.mode = 99;
    controller.running = M3_TRUE;
    M3_TEST_EXPECT(m3_anim_controller_step(&controller, 0.1f, &value, &finished), M3_ERR_INVALID_ARGUMENT);
