...
int main(void)
{
    ...
    M3_TEST_EXPECT(m3_rect_intersect(NULL, &b, &out, &hit), M3_ERR_INVALID_ARGUMENT);
    M3_TEST_EXPECT(m3_rect_intersect(&a, NULL, &out, &hit), M3_ERR_INVALID_ARGUMENT);
    M3_TEST_EXPECT(m3_rect_intersect(&a, &b, NULL, &hit), M3_ERR_INVALID_ARGUMENT);
    M3_TEST_EXPECT(m3_rect_intersect(&a, &b, &out, NULL), M3_ERR_INVALID_ARGUMENT);
    ...
    M3_TEST_EXPECT(m3_rect_contains_point(NULL, 0.0f, 0.0f, &hit), M3_ERR_INVALID_ARGUMENT);
    M3_TEST_EXPECT(m3_rect_contains_point(&a, 0.0f, 0.0f, NULL), M3_ERR_INVALID_ARGUMENT);
    ...
    M3_TEST_EXPECT(m3_mat3_transform_point(NULL, 0.0f, 0.0f, &out_x, &out_y), M3_ERR_INVALID_ARGUMENT);
    M3_TEST_EXPECT(m3_mat3_transform_point(&mat, 0.0f, 0.0f, NULL, &out_y), M3_ERR_INVALID_ARGUMENT);
    M3_TEST_EXPECT(m3_mat3_transform_point(&mat, 0.0f, 0.0f, &out_x, NULL), M3_ERR_INVALID_ARGUMENT);

    memset(&mat, 0, sizeof(mat));
    M3_TEST_EXPECT(m3_mat3_transform_point(&mat, 1.0f, 1.0f, &out_x, &out_y), M3_ERR_RANGE);
