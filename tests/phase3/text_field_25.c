...
static const CMPTextVTable mock_vtable = {
...
int main(void) {
    ...
    CMP_TEST_EXPECT(cmp_text_field_insert_utf8(&field, "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", 70), CMP_ERR_IO);
