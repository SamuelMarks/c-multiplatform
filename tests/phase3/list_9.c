...
int main(void) {
    ...
    color.r = -1.0f; color.g = 0.0f; color.b = 0.0f; color.a = 0.0f;
    CMP_TEST_EXPECT(cmp_list_test_validate_color(&color), CMP_ERR_RANGE);
    color.r = 0.0f; color.g = -1.0f;
    CMP_TEST_EXPECT(cmp_list_test_validate_color(&color), CMP_ERR_RANGE);
    color.g = 0.0f; color.b = -1.0f;
    CMP_TEST_EXPECT(cmp_list_test_validate_color(&color), CMP_ERR_RANGE);
    color.b = 0.0f; color.a = -1.0f;
    CMP_TEST_EXPECT(cmp_list_test_validate_color(&color), CMP_ERR_RANGE);
    color.a = 0.0f;
    ...
    edges.left = -1.0f; edges.right = 0.0f; edges.top = 0.0f; edges.bottom = 0.0f;
    CMP_TEST_EXPECT(cmp_list_test_validate_edges(&edges), CMP_ERR_RANGE);
    edges.left = 0.0f; edges.right = -1.0f;
    CMP_TEST_EXPECT(cmp_list_test_validate_edges(&edges), CMP_ERR_RANGE);
    edges.right = 0.0f; edges.top = -1.0f;
    CMP_TEST_EXPECT(cmp_list_test_validate_edges(&edges), CMP_ERR_RANGE);
    edges.top = 0.0f; edges.bottom = -1.0f;
    CMP_TEST_EXPECT(cmp_list_test_validate_edges(&edges), CMP_ERR_RANGE);
    edges.bottom = 0.0f;
    ...
    rect.width = 0.0f; rect.height = -1.0f;
    CMP_TEST_EXPECT(cmp_list_test_validate_rect(&rect), CMP_ERR_RANGE);
    rect.height = 0.0f;
    ...
    CMPMeasureSpec spec;
    spec.mode = 99;
    CMP_TEST_EXPECT(cmp_list_test_validate_measure_spec(spec), CMP_ERR_INVALID_ARGUMENT);
    spec.mode = CMP_MEASURE_EXACTLY; spec.size = -1.0f;
