...
int main(void) {
  ...
  CMP_TEST_EXPECT(cmp_text_field_test_validate_text_style(&ts, CMP_TRUE),
                  CMP_ERR_INVALID_ARGUMENT);
  ts.utf8_family = "test";
  ts.size_px = 0;
  CMP_TEST_EXPECT(cmp_text_field_test_validate_text_style(&ts, CMP_FALSE),
                  CMP_ERR_RANGE);
  ts.size_px = 12;
  ts.weight = 0;
  CMP_TEST_EXPECT(cmp_text_field_test_validate_text_style(&ts, CMP_FALSE),
  ...
  CMP_TEST_EXPECT(
      cmp_text_field_test_validate_style(&style, CMP_FALSE, CMP_FALSE),
      CMP_ERR_RANGE);
  style.outline_width = 1.0f;
