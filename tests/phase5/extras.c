...
int main(void) {
  ...
  color.b = 0.0f;
  color.a = 0.0f;
  CMP_TEST_EXPECT(cmp_extras_test_validate_color(NULL),
  ...
  CMP_TEST_EXPECT(cmp_extras_test_validate_edges(NULL),
                  CMP_ERR_INVALID_ARGUMENT);
  edges.left = -1.0f;
  edges.right = 0.0f;
  edges.top = 0.0f;
  ...
  CMP_TEST_EXPECT(cmp_extras_test_validate_rect(NULL),
                  CMP_ERR_INVALID_ARGUMENT);
  bounds.x = 0.0f;
  bounds.y = 0.0f;
  bounds.width = -1.0f;
  ...
  CMP_TEST_EXPECT(cmp_extras_test_validate_size(NULL),
                  CMP_ERR_INVALID_ARGUMENT);
  ...
  CMP_TEST_OK(cmp_tooltip_style_init_plain(&tooltip_style));
  CMP_TEST_EXPECT(
      cmp_extras_test_validate_tooltip_style(&tooltip_style, CMP_TRUE),
      CMP_ERR_INVALID_ARGUMENT);
  ...
  CMP_TEST_EXPECT(
      cmp_extras_test_validate_tooltip_placement(&tooltip_placement),
      CMP_ERR_RANGE);
  ...
  CMP_TEST_EXPECT(
      ...
      CMP_ERR_INVALID_ARGUMENT);
  CMP_TEST_EXPECT(
      cmp_extras_test_validate_tooltip_content(&tooltip_style, NULL),
      CMP_ERR_INVALID_ARGUMENT);
  ...
  CMP_TEST_EXPECT(cmp_extras_test_validate_tooltip_content(&tooltip_style,
                                                           &tooltip_content),
                  CMP_ERR_INVALID_ARGUMENT);
  ...
  tooltip_content.has_title = CMP_TRUE;
  tooltip_content.has_body = CMP_TRUE;
  CMP_TEST_OK(cmp_tooltip_compute_content_size(
      &tooltip_style_rich, &tooltip_content, &tooltip_size));
  ...
  CMP_TEST_EXPECT(
      cmp_tooltip_compute_bounds(NULL, &tooltip_anchor, &tooltip_placement,
                                 &overlay, &tooltip_size, &bounds, &direction),
      CMP_ERR_INVALID_ARGUMENT);
  CMP_TEST_OK(cmp_tooltip_style_init_plain(&tooltip_style));
  tooltip_anchor.type = CMP_TOOLTIP_ANCHOR_RECT;
  tooltip_anchor.rect.x = 0.0f;
  ...
  CMP_TEST_EXPECT(cmp_tooltip_compute_bounds(
                      &tooltip_style, &tooltip_anchor, &tooltip_placement,
                      &overlay, &tooltip_size, &bounds, &direction),
                  CMP_ERR_RANGE);
  tooltip_style.variant = 99;
  ...
  CMP_TEST_ASSERT(cmp_near(badge_style.dot_diameter,
                           CMP_BADGE_DEFAULT_DOT_DIAMETER, 0.001f));
  ...
  CMP_TEST_EXPECT(cmp_badge_placement_init_icon(NULL),
                  CMP_ERR_INVALID_ARGUMENT);
  ...
  CMP_TEST_ASSERT(
      cmp_near(badge_size.height, badge_style.dot_diameter, 0.001f));
  badge_content.has_text = CMP_TRUE;
  ...
  bounds.height = 20.0f;
  badge_style.min_size = -1.0f;
  CMP_TEST_EXPECT(cmp_badge_compute_bounds(&badge_style, &badge_content,
                                           &bounds, &badge_placement,
                                           &badge_bounds),
                  CMP_ERR_RANGE);
  badge_placement.corner = CMP_BADGE_CORNER_TOP_LEFT;
  CMP_TEST_EXPECT(cmp_badge_compute_bounds(&badge_style, &badge_content,
