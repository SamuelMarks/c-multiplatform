...
static int test_cupertino_picker(void) {
    ...
    CMP_TEST_EXPECT(cupertino_picker_init(NULL, &text_backend), CMP_ERR_INVALID_ARGUMENT);
    CMP_TEST_EXPECT(cupertino_picker_init(&picker, NULL), CMP_ERR_INVALID_ARGUMENT);
    CMP_TEST_EXPECT(cupertino_picker_init(&picker, &text_backend), CMP_OK);

    CMP_TEST_EXPECT(cupertino_picker_add_item(NULL, "Item 1"), CMP_ERR_INVALID_ARGUMENT);
    CMP_TEST_EXPECT(cupertino_picker_add_item(&picker, NULL), CMP_ERR_INVALID_ARGUMENT);
    ...
    CMP_TEST_EXPECT(cupertino_picker_set_selected(NULL, 1, CMP_FALSE), CMP_ERR_INVALID_ARGUMENT);
    CMP_TEST_EXPECT(cupertino_picker_set_selected(&picker, -1, CMP_FALSE), CMP_ERR_INVALID_ARGUMENT);
    CMP_TEST_EXPECT(cupertino_picker_set_selected(&picker, 2, CMP_FALSE), CMP_ERR_INVALID_ARGUMENT);
    ...
    CMP_TEST_EXPECT(cupertino_picker_paint(&picker, NULL), CMP_ERR_INVALID_ARGUMENT);
