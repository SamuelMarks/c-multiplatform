...
int main(void) {
  ...
  M3_TEST_EXPECT(alloc.realloc(alloc.ctx, ptr, 0, &ptr2),
                 M3_ERR_INVALID_ARGUMENT);
  M3_TEST_EXPECT(alloc.realloc(alloc.ctx, ptr, 32, NULL),
                 M3_ERR_INVALID_ARGUMENT);
  ...
  M3_TEST_EXPECT(alloc.realloc(alloc.ctx, NULL, 0, &ptr),
                 M3_ERR_INVALID_ARGUMENT);
  M3_TEST_EXPECT(alloc.realloc(alloc.ctx, NULL, 8, NULL),
                 M3_ERR_INVALID_ARGUMENT);
  ...
  ptr = NULL;
  M3_TEST_EXPECT(alloc.realloc(alloc.ctx, NULL, max_size, &ptr),
