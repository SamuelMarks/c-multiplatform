...
int main(void) {
  ...
  const unsigned char invalid_two_high_cont_bytes[] = {0xC2u, 0xFFu, '\0'};
  const unsigned char invalid_trunc3_bytes[] = {0xE2u, 0x82u, '\0'};
  const unsigned char invalid_bad_b2_bytes[] = {0xE2u, 0x82u, 0x28u, '\0'};
  const unsigned char invalid_three_high_b1_bytes[] = {0xE2u, 0xFFu, 0x80u,
                                                       '\0'};
  ...
  const unsigned char invalid_bad_b2_4_bytes[] = {0xF0u, 0x90u, 0x28u, 0xBCu,
                                                  '\0'};
  const unsigned char invalid_four_high_b3_bytes[] = {0xF0u, 0x90u, 0x80u,
                                                      0xFFu, '\0'};
  ...
  const char *invalid_two_high_cont = (const char *)invalid_two_high_cont_bytes;
  const char *invalid_trunc3 = (const char *)invalid_trunc3_bytes;
  const char *invalid_bad_b2 = (const char *)invalid_bad_b2_bytes;
  const char *invalid_three_high_b1 = (const char *)invalid_three_high_b1_bytes;
  ...
  const char *invalid_four_high_b3 = (const char *)invalid_four_high_b3_bytes;
  ...
  CMP_TEST_OK(cmp_utf8_validate(invalid_two_high_cont, 2, &valid));
  CMP_TEST_ASSERT(valid == CMP_FALSE);
  ...
  CMP_TEST_OK(cmp_utf8_validate(invalid_three_high_b1, 3, &valid));
  CMP_TEST_ASSERT(valid == CMP_FALSE);
  ...
  CMP_TEST_OK(cmp_utf8_validate(invalid_four_high_b3, 4, &valid));
  CMP_TEST_ASSERT(valid == CMP_FALSE);
  ...
  advance = 0;
  CMP_TEST_EXPECT(cmp_utf8_test_cstrlen(NULL, &max_size),
                  CMP_ERR_INVALID_ARGUMENT);
  CMP_TEST_EXPECT(cmp_utf8_test_cstrlen("x", NULL), CMP_ERR_INVALID_ARGUMENT);
  ...
  CMP_TEST_EXPECT(
      ...
      CMP_ERR_CORRUPT);
  CMP_TEST_EXPECT(cmp_utf8_test_decode((const cmp_u8 *)invalid_two_high_cont, 2,
                                       &codepoint, &advance),
                  CMP_ERR_CORRUPT);
  CMP_TEST_EXPECT(cmp_utf8_test_decode((const cmp_u8 *)invalid_three_high_b1, 3,
                                       &codepoint, &advance),
                  CMP_ERR_CORRUPT);
  CMP_TEST_EXPECT(cmp_utf8_test_decode((const cmp_u8 *)invalid_four_high_b3, 4,
                                       &codepoint, &advance),
                  CMP_ERR_CORRUPT);
